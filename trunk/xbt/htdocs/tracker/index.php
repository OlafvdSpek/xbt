...
<pre>
apt-get install g++ libboost-date-time-dev libboost-dev libboost-filesystem-dev libboost-program-options-dev libboost-regex-dev libmysqlclient15-dev subversion zlib1g-dev
</pre>

The following commands can be used to install some of the dependencies on Fedora Core.
The g++ version should be at least 3.4.
<pre>
yum install boost-devel mysql-devel subversion
</pre>
